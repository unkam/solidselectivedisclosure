...
const remoteUrl = "https://issuer13.solidcommunity.net/public/credentials/inputDocument.json";
const localUrl = require (path.join(__dirname, "../src/data/inputDocument.json"));
...
console.log(JSON.stringify(localUrl, null, 2))
