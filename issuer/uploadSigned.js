...
const remoteUrl = 'https://issuer13.solidcommunity.net/public/credentials/SignedDocument.json';
const localUrl = require (path.join(__dirname, "../src/data/signedDocument.json"));
...
console.log(`${res.status} Uploaded Signed Credential to ${res.url}`)
}
main();
