...
const remoteUrl = 'https://verifier13.solidcommunity.net/public/credentials/verifiedProof.json';
const localUrl = require (path.join(__dirname, "../src/data/verifiedProof.json"));
...
console.log(`${res.status} Uploaded Verified Proof to ${res.url}`)
}
main();
